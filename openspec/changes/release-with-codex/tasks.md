...
- [x] 1.1 Create a repo-local Codex skill (`/tinymist:release v0.14.x`) and matching prompt entry for release preparation under `.github/skills/` and `.github/prompts/`.

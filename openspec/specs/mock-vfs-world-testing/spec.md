# mock-vfs-world-testing Specification

## Purpose
The mock-vfs-world-testing specification defines reusable Rust test support for deterministic Tinymist VFS, world, and project-runtime tests. It lets tests build compiler runtimes from in-memory workspaces and drive file-manipulation flows without relying on host filesystem state, package services, or system-font discovery.
## Requirements

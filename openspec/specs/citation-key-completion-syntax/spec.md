# citation-key-completion-syntax Specification

## Purpose
The citation-key-completion-syntax specification defines how Tinymist inserts bibliography-entry completions inside `#cite(...)`. It ensures the inserted text always uses a valid Typst citation form for the selected bibliography key and keeps raw-key and title-backed completion variants consistent for the same entry.
## Requirements

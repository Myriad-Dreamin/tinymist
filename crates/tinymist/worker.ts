...
import { TinymistLanguageServer } from "./pkg/tinymist";
...
connection.onSelectionRanges((params) => {
  try {
    ...
    return server.selection_range(params.textDocument.uri, params.positions);
  } catch (e) {
...
connection.onRequest(
  ...
  (params: SemanticTokensDeltaParams) => {
    try {
      return server.semantic_tokens_delta(params.textDocument.uri, params.previousResultId);
    } catch (e) {

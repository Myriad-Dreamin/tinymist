...
You can either use `eglot-workspace-configuration` or specifying initial
launch argument for `tinymist`.
...
You can run command `tinymist help lsp` to view all available initial argument
configurations.

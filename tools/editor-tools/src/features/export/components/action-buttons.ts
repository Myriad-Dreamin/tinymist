...
export const ActionButtons = ({ exportConfig }: ActionButtonsProps) => () => {
  ...
  return div(
    ...
    div(
      {
        class: "card",
        style: "margin-top: 1rem; padding: 1rem; background: var(--vscode-textCodeBlock-background);"
      },
      div(
      ...
      div(
        { style: "font-size: 0.875rem; color: var(--vscode-descriptionForeground); line-height: 1.4;" },
